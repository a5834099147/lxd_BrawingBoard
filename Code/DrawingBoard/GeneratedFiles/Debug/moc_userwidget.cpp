...
static const char qt_meta_stringdata_UserWidget[] = {
    "UserWidget\0\0usbState\0changeUsbState(QString)\0"
    "account,userName,userPinyin,on_line\0"
    "insertUserList(std::string,std::string,std::string,bool)\0"
    "on_exportB_clicked()\0on_importB_clicked()\0"
    "on_inquiryE_changed()\0"
};
...
void UserWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->changeUsbState((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->insertUserList((*reinterpret_cast< std::string(*)>(_a[1])),(*reinterpret_cast< std::string(*)>(_a[2])),(*reinterpret_cast< std::string(*)>(_a[3])),(*reinterpret_cast< bool(*)>(_a[4]))); break;
        case 2: _t->on_exportB_clicked(); break;
        case 3: _t->on_importB_clicked(); break;
        case 4: _t->on_inquiryE_changed(); break;
        default: ;
        }
    }
}
