...
static const char qt_meta_stringdata_Register[] = {
    "Register\0\0account,password,userName,yinYin\0"
    "sand_register(std::string,std::string,std::string,std::string)\0"
    "result\0recive_register(bool)\0"
    "on_registerB_clicked()\0on_register_recive(bool)\0"
};
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sand_register((*reinterpret_cast< std::string(*)>(_a[1])),(*reinterpret_cast< std::string(*)>(_a[2])),(*reinterpret_cast< std::string(*)>(_a[3])),(*reinterpret_cast< std::string(*)>(_a[4]))); break;
        case 1: _t->recive_register((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->on_registerB_clicked(); break;
        case 3: _t->on_register_recive((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void Register::sand_register(std::string _t1, std::string _t2, std::string _t3, std::string _t4)
{
...
// SIGNAL 1
void Register::recive_register(bool _t1)
{
