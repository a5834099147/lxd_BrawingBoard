...
namespace odb
{
        ...
        bool* t)
  {
    ...
    if (t[4UL])
    {
      i.user_name_pinyin_value.capacity (i.user_name_pinyin_size);
      grew = true;
    }
        ...
        sqlite::statement_kind sk)
  {
    ...
    b[n].buffer = i.account_value.data ();
    ...
    b[n].size = &i.user_name_size;
    b[n].capacity = i.user_name_value.capacity ();
    ...
    b[n].type = sqlite::image_traits<
      ::std::string,
      sqlite::id_text>::bind_value;
    b[n].buffer = i.user_name_pinyin_value.data ();
    b[n].size = &i.user_name_pinyin_size;
    b[n].capacity = i.user_name_pinyin_value.capacity ();
    b[n].is_null = &i.user_name_pinyin_null;
    n++;
  }
        ...
        sqlite::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t cap (i.user_name_pinyin_value.capacity ());
      sqlite::value_traits<
          ::std::string,
          sqlite::id_text >::set_image (
        i.user_name_pinyin_value,
        i.user_name_pinyin_size,
        is_null,
        v);
      i.user_name_pinyin_null = is_null;
      grew = grew || (cap != i.user_name_pinyin_value.capacity ());
    }
      ...
      switch (pass)
      {
        case 1:
        {
          db.execute ("CREATE TABLE \"User\" (\n"
                      ...
                      "  \"user_name_pinyin\" TEXT NOT NULL)");
          return false;
        }
      }
    }
